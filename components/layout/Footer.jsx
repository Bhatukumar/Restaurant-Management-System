          ...
          <div className="md:flex-1">
            ...
            <div className="flex flex-col gap-y-2 mt-3">
              <a href={footer?.location} target="_blank" rel="noreferrer">
                ...
                <span className="inline-block ml-2">Vrudheshwar Ghat, Opposite Congress Bhavan, Shivaji Nagar, Pune</span>
              </a>
              <div>
                ...
                >
                  {footer?.phoneNumber} 91+ 8411011466
                </a>
              </div>
              <a href={`mailto:${footer?.email}`}>
                <i className="fa fa-envelope"></i>
                <span className="inline-block ml-2">{footer?.email}admin@gmail.com</span>
              </a>
            </div>
          </div>
          <div className="md:flex-1">
            <Title addClass="text-[38px]">Vrudeshwar Pure Veg</Title>
